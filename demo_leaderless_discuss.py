...
def main():
    ...
    for i in range(1, 10):
        idx = exp.choose_next_one(message="Please consider his/her characteristics and experience , give a number from 1 to 100, indicating the probability of he/she speaking at the next moment. The greater the value, the higher the probability. Just reply the number")
